          ...
          <div className="md:col-span-5">
            ...
            >
              <Link href="#home" className="block">
                <div className="relative h-16 w-auto max-w-[240px] vhs-tracking">
                  <Image
                    src="/thrifthood_logo.png"
                    alt="ThriftHood.cy Logo"
                    width={240}
                    height={80}
                    className="object-contain h-full w-full animate-vhs-flicker"
                    style={{
                  ...
                  {/* Distortion effect for the logo */}
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/10 to-transparent opacity-30 mix-blend-overlay"></div>

                  {/* Static overlay */}
                  <div className="absolute inset-0 bg-static opacity-10 mix-blend-overlay"></div>

                  {/* Scan line */}
                  <div className="absolute left-0 w-full h-[2px] bg-thrift-purple opacity-30 top-1/2 -translate-y-1/2"></div>
                </div>
              </Link>
            </motion.div>
